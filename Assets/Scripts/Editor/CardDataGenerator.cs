...
namespace TwinsDefense.EditorTools
{
    ...
    public static class CardDataGenerator
    {
        ...
        private static readonly SpecialCardDef[] SpecialCards =
        {
            ...
            new SpecialCardDef("guardians_bargain", "Guardian's Bargain", CardEffectType.Defense, 100f, true, CardEffectType.Damage, -30f, true),
            ...
            new SpecialCardDef("swarm_caller", "Swarm Caller", CardEffectType.ExtraProjectile, 2f, false, CardEffectType.Damage, -40f, true),
        ...
        public static void GenerateCardData()
        {
            ...
            List<CardData> createdCards = new List<CardData>(Cards.Length + SpecialCards.Length);
            ...
            Debug.Log($"CardDataGenerator: generated {createdCards.Count} card asset(s) ({SpecialCards.Length} special) + CardPoolConfig at '{CardsFolder}'.");
        }
    }
}
